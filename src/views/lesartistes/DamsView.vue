<template>
  <div>
    ...
    <div class="px-10">
      <h1 class="text-3xl font-bold">Dimanche 31 juillet</h1>
      <h1 class="py-4 text-sm font-medium">
        TravS de son vrai nom Jack Bean Weer II, né le 17 avril 2000 à Houston
        au Texas, est un rappeur, chanteur, producteur, musicien, acteur,
        mannequin et réalisateur américain. Il a aussi collaboré avec beaucoup
        de grandes marques.
        <br />
        <br />
        Friand de musique ambiansante, festive, énervé et en feu.Il sera présent
        toute la nuit du mardi 26 juillet 2022 au Night of Republique festival.
        Ces deux derniers albums le font connaitre de plus en plus aux USA, il a
        decider de partager sa musique en France. Et de nous rejoindre dans
        cette aventure angevine nocturne.
      </h1>
    </div>

    <div class="px-10 py-10">
      <h1 class="text-xl font-bold">Suivre Dems sur ...</h1>
        ...
        <div class="">
          <div class="">
            ...
            <input
              ...
              id="email"
              type="email"
              placeholder="arthursaturni@gmail.com"
            />
            <p class="pb-4 text-xs italic">*champs obligatoire</p>
          </div>
        </div>
          ...
          <div class="w-full px-3">
            <div class="flex flex-col">
              <div class="flex flex-col py-6">
                <label class="mt-16 inline-flex text-left text-xs">
                  <input
                    type="checkbox"
                    class="form-checkbox h-5 w-5"
                    checked
                  /><span class="ml-2">J’ai compris et j’accepte (1)</span>
                </label>
              </div>
            </div>
          </div>
